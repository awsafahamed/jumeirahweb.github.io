...
document.addEventListener("DOMContentLoaded", function () {
  const selectHotel = document.getElementById("select-hotel-dd");
  ...
  selectHotel.addEventListener("change", function () {
      ...
      const selectedContent = document.getElementById(selectHotel.value + "-content");
      if (selectedContent) {
...
$(document).ready(function () {
  $('.input-group.date').datepicker({
    format: 'dd M yyyy', // Customize the date format as needed
    autoclose: true,
    clearBtn: true,
    todayHighlight: true,
    orientation: 'bottom',
